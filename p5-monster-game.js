...
module.exports = class MonsterGame {
  ...
  listMonsters = () => {
    ...
    this.monsters.forEach(monster => {
        (monster.isAlive == true ) ? temp = "Alive" : temp = "Dead";
        console.log( `Monster: ${monster.monsterName}, Minimum Life: ${monster.minimumLife}, Current Life: ${monster.currentLife}, Status: ${temp}`);
